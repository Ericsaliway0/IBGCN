## (kg39) ericsali@erics-MacBook-Pro-4 gnn_pathways % python __pertag_driver_gene_prediction_chebnet_gpu_usage_pass_distr_2048.py --model_type IBGCN --net_type CPDB --score_threshold 0.99 --hidden_feats 1024 --learning_rate 0.001 --num_epochs 105
## (kg39) ericsali@erics-MacBook-Pro-4 gnn_pathways % python __pertag_driver_gene_prediction_chebnet_gpu_usage_pass_distr_2048.py --model_type IBGCN --net_type HIPPIE --score_threshold 0.99 --in_feats 2048 --hidden_feats 256 --learning_rate 0.001 --num_epochs 105

## (kg39) ericsali@erics-MacBook-Pro-4 gnn_pathways % python __pertag_driver_gene_prediction_chebnet_gpu_usage_pass_distr_2048.py --model_type IBGCN --score_threshold 0.99 --learning_rate 0.001 --num_epochs 204
## p_value in average predicted score
## (kg39) ericsali@erics-MacBook-Pro-4 gnn_pathways % python __pertag_driver_gene_prediction_chebnet_gpu_usage_pass_distr_2048.py --model_type IBGCN --net_type STRING --score_threshold 0.99 --learning_rate 0.001 --num_epochs 505
...
from .models import IBGCN, HGDC, EMOGI, MTGCN, GCN, GAT, GraphSAGE, GIN, ChebNet, ChebNet, ChebNetII, DMGNN, FocalLoss
import pandas as pd
...
def choose_model(model_type, in_feats, hidden_feats, out_feats):
    if model_type == 'GraphSAGE':
        ...
        return HGDC(in_feats, hidden_feats, out_feats)
    ...
    elif model_type == 'IBGCN':
        return IBGCN(in_feats, hidden_feats, out_feats)
        ...
        raise ValueError(
            ...
            "'MTGCN', 'GCN', 'GIN', 'ChebNet', 'ChebNetII', 'IBGCN', 'DMGNN']."
        ) 
        
        # ValueError("Invalid model type. Choose from ['GraphSAGE', 'GAT', 'EMOGI', 'HGDC', 'MTGCN', 'GCN', 'GIN', 'Chebnet', 'IBGCN'].")
